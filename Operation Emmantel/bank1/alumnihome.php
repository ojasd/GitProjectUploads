...
<div class="wrapper">
	...
	<section align="right">
	<marquee style= HEIGHT=250 WIDTH=350 direction="up">
	University<br><IMG SRC="images/faculty.jpg"><br>
	Student<br><IMG SRC="images/student-image-2.jpg">
	</marquee>
	
	<marquee id='scroll_news' style="font-family:Book Antiqua; color: #FFFFFF" bgcolor="#011220" >
	<div onMouseOver="document.getElementById('scroll_news').stop();" onMouseOut="document.getElementById('scroll_news').start();">
	<a href=../php_tutorial/site_map.php>PHP</a> | <a href=../sql_tutorial/site_map.php>SQL</a> | <a href=../>plus2net Home</a>
	</div>
	</marquee>
